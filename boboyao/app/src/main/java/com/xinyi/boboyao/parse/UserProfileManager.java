package com.xinyi.boboyao.parse;
...
import com.xinyi.boboyao.AppHelper;
...
public class UserProfileManager {
	...
	public synchronized boolean init(Context context) {
		...
		syncContactInfosListeners = new ArrayList<AppHelper.DataSyncListener>();
		sdkInited = true;
		return true;
	}

	public void addSyncContactInfoListener(AppHelper.DataSyncListener listener) {
		if (listener == null) {
			return;
		}
	...
	public void removeSyncContactInfoListener(AppHelper.DataSyncListener listener) {
		if (listener == null) {
			return;
		}
		if (syncContactInfosListeners.contains(listener)) {
	...
	public void notifyContactInfosSyncListener(boolean success) {
		for (AppHelper.DataSyncListener listener : syncContactInfosListeners) {
