package com.xinyi.boboyao.circleFriend.viewholder;
...
import com.xinyi.boboyao.circleFriend.widget.popup.CommentPopup;
import com.xinyi.boboyao.circleFriend.widget.popup.DeleteCommentPopup;
import com.xinyi.boboyao.circleFriend.widget.praisewidget.PraiseWidget;
    ...
    private CommentContentsLayout.OnCommentItemClickListener onCommentItemClickListener = new CommentContentsLayout.OnCommentItemClickListener() {
        ...
        public void onCommentWidgetClick(@NonNull CommentWidget widget) {
            ...
            if (commentInfo.canDelete()) {
                ...
                //changed by niuxb 2017/12/19
                momentPresenter.showCommentBox(itemView, itemPosition, momentsInfo.getMomentid(), widget);
            }
        }
    };
